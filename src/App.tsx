  ...
  return (
    <div className="container md:mx-auto">
      <header className="flex justify-between items-center  mt-10 mb-20">
        <div>
          <img src={coffeLogo} alt="logo coffe-shop" className="w-20" />
        </div>
      ...
      <main>
        <section className="lg:flex">
          <div>
            <h1 className="text-6xl text-title font-baloo2 font-extrabold text-center md:text-left">
              Encontre o café perfeito para qualquer hora do dia
            </h1>
            <h2 className="text-xl text-subtitle mt-5 text-center md:text-left ">
          ...
          <div className="mt-14 flex flex-wrap justify-center lg:justify-start xl:justify-around gap-10">
            ...
            <div className="bg-card relative w-[18rem] rounded-tr-3xl rounded-bl-3xl py-5">
              ...
              <div className="text-center">
                ...
                <p className="text-label px-2 mt-5 mb-10">
                  Uma dose de café expresso com o dobro de leite e espuma
                  cremosa
                </p>
              </div>
              <div className="px-4 flex items-center justify-around">
            ...
            <div className="bg-card relative w-[18rem] rounded-tr-3xl rounded-bl-3xl py-5">
              ...
              <div className="text-center">
                ...
                <p className="text-label px-2 mt-5 mb-10">
                  Bebida com canela feita de doses iguais de café, leite e
                  espuma
                </p>
              </div>
              <div className="px-4 flex items-center justify-around">
